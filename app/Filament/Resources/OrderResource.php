        ...
        return $form
            ->schema([
                ...
                Section::make('Індивідуальні цілі КБЖУ')
                    ...
                    ->columns(3)
                    // Секція завжди розгорнута — інакше при live-оновленні banner-а
                    // (як тільки цілі стають досяжними / зеленими) Filament
                    // перечитує collapsed-стан і згортає секцію під користувачем.
                    // Автозгортання прибрано; кнопка «звернути» лишається, якщо
                    // менеджер сам захоче.
                    ->collapsible()
                    ->schema([
