...
<div class="grid grid-cols-1 md:grid-cols-6 gap-4 mb-6 p-4 rounded-2xl border border-amber-500/20 bg-amber-500/5">
    <div class="md:col-span-6 flex items-center gap-2 mb-1">
