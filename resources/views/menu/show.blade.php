...
<div class="content">
    ...
    @else
        ...
        {{-- Дисклеймер про автозаміни --}}
        <p style="margin: 18px 4px 24px; font-size: 11px; line-height: 1.5; color: #94a3b8; font-style: italic; text-align: center;">
            *Кухня залишає за собою право автоматично замінювати окремі продукти або інгредієнти у раціонах на аналогічні за харчовою цінністю та категорією у випадку відсутності продукту, сезонності, технічної необхідності або виробничих потреб.
        </p>
